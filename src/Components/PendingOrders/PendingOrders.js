    ...
    return (
       <React.Fragment key={props.item.id}>
            <div className="bg-[#FFBF69] shadow-md rounded-2xl font-poppins font-light h-[100%]">
                ...
                <div>
                    <button onClick={() => orderCompleted(props.item.id, props.item.data)} className='font-medium bg-[#1B1A1A] hover:bg-[#FE9C08] text-white shadow-md rounded-2xl px-[6%] py-[1%] w-[20vw]'>
                        Mark as ready
                    </button>    
                </div>
            </div>
